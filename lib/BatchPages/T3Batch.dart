...
class T3Batch extends StatefulWidget {
  final String currentUserId;
  final String PRN;
  final String Mentoruid;

  const T3Batch({super.key, required this.currentUserId,required this.PRN,required this.Mentoruid});

  @override
  State<T3Batch> createState() => _T3BatchState();
}

class _T3BatchState extends State<T3Batch> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Expanded(
            child: StreamBuilder(
              stream: FirebaseFirestore.instance.collection('messages-t3').orderBy('messageTimeStamp', descending: true).snapshots(),
  ...
  void _sendMessage() {
    ...
    if (messageText.isNotEmpty) {
      FirebaseFirestore.instance.collection('messages-t3').add({
        'prn':widget.PRN,
