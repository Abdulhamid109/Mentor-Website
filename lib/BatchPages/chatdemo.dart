...
class T1Batch extends StatefulWidget {
  ...
  const T1Batch({Key? key, required this.currentUserId,required this.PRN}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Expanded(
            child: StreamBuilder(
              stream: FirebaseFirestore.instance.collection('messages-t1').orderBy('messageTimeStamp', descending: true).snapshots(),
                                    ...
                                    onPressed: () async{
                                      ...
                                      if (now.weekday == DateTime.saturday &&
                                        ...
                                        print(
                                          ...
                                          DocumentReference mydoc = FirebaseFirestore.instance.collection('student-t1').doc(widget.currentUserId);
